## Code for training the pre-trained Unet with autoencoder weights
...
if __name__ == "__main__":
    ...
    PATIENCE = 5               
    DATA_PATH = "./Dataset"
    MODEL_SAVE_PATH = "./Saved_Models/unet_autoencoderweights.pth"
    AUTOENCODER_PATH = "./Saved_Models/autoencoder_best.pth"
    ...
    # Transfer weights from autoencoder encoder to UNet encoder.
    model.down_convolution_1.load_state_dict(autoencoder.down_convolution_1.state_dict())
    model.down_convolution_2.load_state_dict(autoencoder.down_convolution_2.state_dict())
    model.down_convolution_3.load_state_dict(autoencoder.down_convolution_3.state_dict())
    model.down_convolution_4.load_state_dict(autoencoder.down_convolution_4.state_dict())
    model.bottle_neck.load_state_dict(autoencoder.bottle_neck.state_dict())

    # Freeze encoder parameters.
    for module in [model.down_convolution_1, model.down_convolution_2, 
                model.down_convolution_3, model.down_convolution_4, 
                model.bottle_neck]:
    ...
    #class_weights = torch.tensor([1.0, 3.0, 2.0, 0.5]).to(device)  
